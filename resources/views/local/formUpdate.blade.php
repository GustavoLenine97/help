        ...
        @csrf
            <div class="box-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ $loc->nome_local }}" name="nome_local" placeholder="Descreva o nome do Local">
                </div>

                <div class="form-group">
                    <label>CEP</label>
                    <input type="text" class="form-control" value="{{ $loc->CEP }}"name="CEP" id="cep" placeholder="Descreva o nome do Local" onblur="pesquisacep(this.value);">
                </div>
